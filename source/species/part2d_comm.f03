...
!       part%x_l( 2, npp + stay_cnt )  = recv_buf_lower( 2 + stride )
      ...
      part%p_l( 1, npp + stay_cnt )  = recv_buf_lower( 3 + stride )
      part%p_l( 2, npp + stay_cnt )  = recv_buf_lower( 4 + stride )
      part%p_l( 3, npp + stay_cnt )  = recv_buf_lower( 5 + stride )
      part%p( 1, npp + stay_cnt )  = recv_buf_lower( 6 + stride )
      part%p( 2, npp + stay_cnt )  = recv_buf_lower( 7 + stride )
      part%p( 3, npp + stay_cnt )  = recv_buf_lower( 8 + stride )
      part%gamma( npp + stay_cnt ) = recv_buf_lower( 9 + stride )
      part%psi( npp + stay_cnt )   = recv_buf_lower( 10 + stride )
      part%q( npp + stay_cnt )     = recv_buf_lower( 11 + stride )
      part%w( npp + stay_cnt )     = recv_buf_lower( 12 + stride )
      part%w0( npp + stay_cnt )     = recv_buf_lower( 13 + stride )
...
!       part%x_l( 2, npp + stay_cnt )  = recv_buf_upper( 2 + stride )
      ...
      part%p_l( 1, npp + stay_cnt )  = recv_buf_upper( 3 + stride )
      part%p_l( 2, npp + stay_cnt )  = recv_buf_upper( 4 + stride )
      part%p_l( 3, npp + stay_cnt )  = recv_buf_upper( 5 + stride )
      part%p( 1, npp + stay_cnt )  = recv_buf_upper( 6 + stride )
      part%p( 2, npp + stay_cnt )  = recv_buf_upper( 7 + stride )
      part%p( 3, npp + stay_cnt )  = recv_buf_upper( 8 + stride )
      part%gamma( npp + stay_cnt ) = recv_buf_upper( 9 + stride )
      part%psi( npp + stay_cnt )   = recv_buf_upper( 10 + stride )
      part%q( npp + stay_cnt )     = recv_buf_upper( 11 + stride )
      part%w( npp + stay_cnt )     = recv_buf_upper( 12 + stride )
      part%w0( npp + stay_cnt )    = recv_buf_upper( 13 + stride )
...
!       send_buf_lower( 2 + stride ) = part%x_l(2,i)
      ...
      send_buf_lower( 3 + stride ) = part%p_l(1,i)
      send_buf_lower( 4 + stride ) = part%p_l(2,i)
      send_buf_lower( 5 + stride ) = part%p_l(3,i)
      send_buf_lower( 6 + stride ) = part%p(1,i)
      send_buf_lower( 7 + stride ) = part%p(2,i)
      send_buf_lower( 8 + stride ) = part%p(3,i)
      send_buf_lower( 9 + stride ) = part%gamma(i)
      send_buf_lower( 10 + stride ) = part%psi(i)
      send_buf_lower( 11 + stride ) = part%q(i)
      send_buf_lower( 12 + stride ) = part%w(i)
      send_buf_lower( 13 + stride ) = part%w0(i)
...
!       send_buf_upper( 2 + stride ) = part%x_l(2,i)
      ...
      send_buf_upper( 3 + stride ) = part%p_l(1,i)
      send_buf_upper( 4 + stride ) = part%p_l(2,i)
      send_buf_upper( 5 + stride ) = part%p_l(3,i)
      send_buf_upper( 6 + stride ) = part%p(1,i)
      send_buf_upper( 7 + stride ) = part%p(2,i)
      send_buf_upper( 8 + stride ) = part%p(3,i)
      send_buf_upper( 9 + stride ) = part%gamma(i)
      send_buf_upper( 10 + stride ) = part%psi(i)
      send_buf_upper( 11 + stride ) = part%q(i)
      send_buf_upper( 12 + stride ) = part%w(i)
      send_buf_upper( 13 + stride ) = part%w0(i)
