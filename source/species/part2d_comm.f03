...
subroutine pack_particles( part )
  ...
  do i = 1, npp
    ...
    elseif ( goto_des( x, redge, p_owd ) ) then
      ...
      send_buf_upper( 10 + stride ) = part%p(1,i)
      send_buf_upper( 11 + stride ) = part%p(2,i)
      send_buf_upper( 12 + stride ) = part%p(3,i)
      send_buf_upper( 13 + stride ) = part%gamma(i)
      send_buf_upper( 14 + stride ) = part%psi(i)
      send_buf_upper( 15 + stride ) = part%q(i)
      send_buf_upper( 16 + stride ) = part%w(i)
      send_buf_upper( 17 + stride ) = part%w0(i)
