...
subroutine unpack_relay_particles( part )
  ...
  do i = 1, recv_cnt(p_iwd)
    ...
    if ( goto_here( x, redge ) ) then
      ...
      part%x_l( 1, npp + stay_cnt )  = recv_buf_lower( 11 + stride )
      part%x_l( 2, npp + stay_cnt )  = recv_buf_lower( 12 + stride )
      part%p_l( 1, npp + stay_cnt )  = recv_buf_lower( 13 + stride )
      part%p_l( 2, npp + stay_cnt )  = recv_buf_lower( 14 + stride )
      part%p_l( 3, npp + stay_cnt )  = recv_buf_lower( 15 + stride )
  ...
  do i = 1, recv_cnt(p_owd)
    ...
    if ( goto_here( x, redge ) ) then
      ...
      part%x_l( 1, npp + stay_cnt )  = recv_buf_upper( 11 + stride )
      part%x_l( 2, npp + stay_cnt )  = recv_buf_upper( 12 + stride )
      part%p_l( 1, npp + stay_cnt )  = recv_buf_upper( 13 + stride )
      part%p_l( 2, npp + stay_cnt )  = recv_buf_upper( 14 + stride )
      part%p_l( 3, npp + stay_cnt )  = recv_buf_upper( 15 + stride )
...
subroutine pack_particles( part )
  ...
  do i = 1, npp
    ...
    if ( goto_des( x, redge, p_iwd ) ) then
      ...
      send_buf_lower( 11 + stride ) = part%x_l(1,i)
      send_buf_lower( 12 + stride ) = part%x_l(2,i)
      send_buf_lower( 13 + stride ) = part%p_l(1,i)
      send_buf_lower( 14 + stride ) = part%p_l(2,i)
      send_buf_lower( 15 + stride ) = part%p_l(3,i)
    ...
    elseif ( goto_des( x, redge, p_owd ) ) then
      ...
      send_buf_upper( 11 + stride ) = part%x_l(1,i)
      send_buf_upper( 12 + stride ) = part%x_l(2,i)
      send_buf_upper( 13 + stride ) = part%p_l(1,i)
      send_buf_upper( 14 + stride ) = part%p_l(2,i)
      send_buf_upper( 15 + stride ) = part%p_l(3,i)
