...
!                   ppart1%q(pp1)     = dxp*m2*0.75
                  ...
                  this%q(pp) = this%q(pp)*(1-0.75/(1-this%w0(pp)))
                  if ((this%w0(pp) + 0.75).ge.1.0) then
                    this%w0(pp) = 1.0
                    this%w(pp) = 0.0
                  else
                    this%w0(pp) = this%w0(pp) + 0.75
                  endif
                  ...
                  this%q(pp) = this%q(pp)*(1-0.5/(1-this%w0(pp)))
                  if ((this%w0(pp) + 0.5).ge.1.0) then
                    this%w0(pp) = 1.0
                    this%w(pp) = 0.0
                  else
                    this%w0(pp) = this%w0(pp) + 0.5
                  endif
                  ...
                  this%q(pp) = this%q(pp)*(1-0.25/(1-this%w0(pp)))
                  if ((this%w0(pp) + 0.25).ge.1.0) then
                    this%w0(pp) = 1.0
                    this%w(pp) = 0.0
                  else
                    this%w0(pp) = this%w0(pp) + 0.25
                  endif
              endif
!             endif
