...
type, public :: profile_laser
  ...
  ! Procedure of setting the transverse profiles
  ...
  ! Procedure of getting the longitudinal profile
...
interface
  ...
  subroutine get_prof_perp_astrl_intf( r, z, t, k, k0, prof_pars, math_funcs, mode, ar_re, ar_im, ai_re, ai_im )
...
subroutine init_profile_laser( this, input, opts, sect_id )
  ...
  select case ( trim(read_str) )
    ...
    case ( 'astrl_analytic' )
      ...
      this%set_prof_perp_astrl => set_prof_perp_astrl_analytic
      this%get_prof_perp_astrl => get_prof_perp_astrl_analytic

    case ( 'astrl_discrete' )
      this%prof_type(1)  = p_prof_laser_astrl_discrete
      this%set_prof_perp_astrl => set_prof_perp_astrl_discrete
      this%get_prof_perp_astrl => get_prof_perp_astrl_discrete
