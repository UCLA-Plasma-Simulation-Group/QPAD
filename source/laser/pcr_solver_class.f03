...
character(len=32), parameter :: cls_name = "pcr_solver"
integer, parameter :: cls_level = 5

type, abstract :: pcr_solver
  ...
  procedure :: new => init_pcr_solver
  procedure :: del => end_pcr_solver
  ...
  procedure(set_struct_matrix_intf), private, deferred :: set_struct_matrix

end type pcr_solver

abstract interface
subroutine set_struct_matrix_intf( this, opts, dr )
  import pcr_solver, options
  implicit none
  class( pcr_solver ), intent(inout) :: this
  type( options ), intent(in) :: opts
  real, intent(in) :: dr
end subroutine set_struct_matrix_intf
end interface

contains

subroutine init_pcr_solver( this, opts, mode, dr )
  ...
  integer :: ierr, comm
  character(len=32), save :: sname = "init_pcr_solver"
...
end subroutine init_pcr_solver

subroutine end_pcr_solver( this )
  ...
  integer :: ierr
  character(len=32), save :: sname = "end_pcr_solver"

  call write_dbg( cls_name, sname, cls_level, 'starts' )

  if ( associated(this%HYPRE_BUF) ) deallocate( this%HYPRE_BUF )
