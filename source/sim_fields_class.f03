...
type sim_fields
  ...
  class( field_rho ), pointer :: q_spe => null(), q_beam => null(), qn => null()
...
subroutine alloc_sim_fields( this, input )
  ...
  if ( .not. associated( this%qn ) )     allocate( field_rho :: this%qn )
...
subroutine init_sim_fields( this, input, opts )
  ...
  call this%qn%new(     opts, max_mode, ps, sm_type, sm_ord )
