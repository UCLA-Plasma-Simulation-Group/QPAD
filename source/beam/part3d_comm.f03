  ...
  case ( 'local' )
    ...
    do i = 1, recv_cnt(p_iwd)
      ...
      if ( goto_here( x, redge, p_iwd ) ) then
        ...
        part%x_l( 1, npp + stay_cnt ) = recv_buf_lower( 4 + stride )
        part%x_l( 2, npp + stay_cnt ) = recv_buf_lower( 5 + stride )
        part%x_l( 3, npp + stay_cnt ) = recv_buf_lower( 6 + stride )
        part%p( 1, npp + stay_cnt ) = recv_buf_lower( 7 + stride )
        part%p( 2, npp + stay_cnt ) = recv_buf_lower( 8 + stride )
        part%p( 3, npp + stay_cnt ) = recv_buf_lower( 9 + stride )
        part%p_l( 1, npp + stay_cnt ) = recv_buf_lower( 10 + stride )
        part%p_l( 2, npp + stay_cnt ) = recv_buf_lower( 11 + stride )
        part%p_l( 3, npp + stay_cnt ) = recv_buf_lower( 12 + stride )
        part%q( npp + stay_cnt )    = recv_buf_lower( 13 + stride )
        if ( part%has_spin ) then
          part%s( 1, npp + stay_cnt ) = recv_buf_lower( 14 + stride )
          part%s( 2, npp + stay_cnt ) = recv_buf_lower( 15 + stride )
          part%s( 3, npp + stay_cnt ) = recv_buf_lower( 16 + stride )
        endif
    ...
    do i = 1, recv_cnt(p_owd)
      ...
      if ( goto_here( x, redge, p_owd ) ) then
        ...
        part%x_l( 1, npp + stay_cnt ) = recv_buf_upper( 4 + stride )
        part%x_l( 2, npp + stay_cnt ) = recv_buf_upper( 5 + stride )
        part%x_l( 3, npp + stay_cnt ) = recv_buf_upper( 6 + stride )
        part%p( 1, npp + stay_cnt ) = recv_buf_upper( 7 + stride )
        part%p( 2, npp + stay_cnt ) = recv_buf_upper( 8 + stride )
        part%p( 3, npp + stay_cnt ) = recv_buf_upper( 9 + stride )
        part%p_l( 1, npp + stay_cnt ) = recv_buf_upper( 10 + stride )
        part%p_l( 2, npp + stay_cnt ) = recv_buf_upper( 11 + stride )
        part%p_l( 3, npp + stay_cnt ) = recv_buf_upper( 12 + stride )
        part%q( npp + stay_cnt )    = recv_buf_upper( 13 + stride )
        if ( part%has_spin ) then
          part%s( 1, npp + stay_cnt ) = recv_buf_upper( 14 + stride )
          part%s( 2, npp + stay_cnt ) = recv_buf_upper( 15 + stride )
          part%s( 3, npp + stay_cnt ) = recv_buf_upper( 16 + stride )
        endif
...
subroutine pack_particles( part, buf_type )
  ...
  case ( 'local' )
    ...
    do i = 1, npp
      ...
      if ( goto_des( x, redge, p_iwd ) ) then
        ...
        send_buf_lower( 4 + stride ) = part%x_l(1,i)
        send_buf_lower( 5 + stride ) = part%x_l(2,i)
        send_buf_lower( 6 + stride ) = part%x_l(3,i)
        send_buf_lower( 7 + stride ) = part%p(1,i)
        send_buf_lower( 8 + stride ) = part%p(2,i)
        send_buf_lower( 9 + stride ) = part%p(3,i)
        send_buf_lower( 10 + stride ) = part%p_l(1,i)
        send_buf_lower( 11 + stride ) = part%p_l(2,i)
        send_buf_lower( 12 + stride ) = part%p_l(3,i)
        send_buf_lower( 13 + stride ) = part%q(i)
        if ( part%has_spin ) then
          send_buf_lower( 14 + stride ) = part%s(1,i)
          send_buf_lower( 15 + stride ) = part%s(2,i)
          send_buf_lower( 16 + stride ) = part%s(3,i)
        endif
      ...
      elseif ( goto_des( x, redge, p_owd ) ) then
        ...
        send_buf_upper( 4 + stride ) = part%x_l(1,i)
        send_buf_upper( 5 + stride ) = part%x_l(2,i)
        send_buf_upper( 6 + stride ) = part%x_l(3,i)
        send_buf_upper( 7 + stride ) = part%p(1,i)
        send_buf_upper( 8 + stride ) = part%p(2,i)
        send_buf_upper( 9 + stride ) = part%p(3,i)
        send_buf_upper( 10 + stride ) = part%p_l(1,i)
        send_buf_upper( 11 + stride ) = part%p_l(2,i)
        send_buf_upper( 12 + stride ) = part%p_l(3,i)
        send_buf_upper( 13 + stride ) = part%q(i)
        if ( part%has_spin ) then
          send_buf_upper( 14 + stride ) = part%s(1,i)
          send_buf_upper( 15 + stride ) = part%s(2,i)
          send_buf_upper( 16 + stride ) = part%s(3,i)
        endif
  ...
  case ( 'pipeline' )
    ...
    do i = 1, npp
      ...
      if ( goto_des( x, zedge, p_fwd ) ) then
        ...
        part%pbuff( 4 + stride ) = part%x_l(1,i)
        part%pbuff( 5 + stride ) = part%x_l(2,i)
        part%pbuff( 6 + stride ) = part%x_l(3,i)
        part%pbuff( 7 + stride ) = part%p(1,i)
        part%pbuff( 8 + stride ) = part%p(2,i)
        part%pbuff( 9 + stride ) = part%p(3,i)
        part%pbuff( 10 + stride ) = part%p_l(1,i)
        part%pbuff( 11 + stride ) = part%p_l(2,i)
        part%pbuff( 12 + stride ) = part%p_l(3,i)
        part%pbuff( 13 + stride ) = part%q(i)
        if ( part%has_spin ) then
          part%pbuff( 14 + stride ) = part%s(1,i)
          part%pbuff( 15 + stride ) = part%s(2,i)
          part%pbuff( 16 + stride ) = part%s(3,i)
        endif
  ...
  do i = go_cnt, 1, -1
    ...
    part%x_l( 1:3, ihole(i) ) = part%x_l( 1:3, npp )
