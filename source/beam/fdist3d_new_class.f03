...
type, abstract :: fdist3d
  ...
  procedure(init_fdist3d_intf), deferred :: new => init_fdist3d
  procedure(end_fdist3d_intf), deferred :: del => end_fdist3d
  procedure(inject_fdist3d_intf), deferred :: inject => inject_fdist3d
