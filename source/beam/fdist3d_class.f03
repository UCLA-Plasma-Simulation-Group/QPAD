...
public :: fdist3d_000, fdist3d_001, fdist3d_002, fdist3d_003, fdist3d_004, fdist3d_100, fdist3d_101
...
! Transverse uniform ( r < R ) and piecewise in z (the same particle charge)
   private

   integer :: npx, npy, npz
   real :: qm, R, rmax, zmin, zmax
   real :: bcx, bcy, bcz, sigvx, sigvy, sigvz
   real :: cx1,cx2,cx3,cy1,cy2,cy3,gamma,np
   real, dimension(:), allocatable :: fz, z
   logical :: quiet
   ...
   procedure, private :: deposit_fdist3d => deposit_fdist3d_004
...
! local data
   integer :: npf,npx,npy,npz,npmax
   real :: qm,R,bcx,bcy,bcz,sigvx,sigvy,sigvz
   real :: cx1,cx2,cx3,cy1,cy2,cy3,gamma,np
   logical :: quiet, evol
   real :: min, max, cwp, n0
   real :: alx, alz, dr, dz, sumz
...
subroutine dist3d_004(this,x,p,q,npp,noff,ndp,s)
...
! edges(4) = upper boundary in z of particle partition
   ...
   integer :: npx, npy, npz, nzf, nz, i, j
   real :: vtx, vty, vtz, vdx, vdy, vdz,dr,dz
   real :: R, x0, y0, z0, rmax, zmin, zmax
   real, dimension(3) :: cx, cy
   real, dimension(4) :: edges
   integer(kind=LG) :: nps, npmax
   logical :: lquiet = .false.
   ...
   call beam_dist004(x,p,q,this%qm,edges,npp,this%dx,this%dz,nps,vtx,vty,vtz,vdx,vdy,&
   &vdz,npx,npy,npz,rmax,zmin,zmax,npmax,R,&
   &x0,y0,z0,cx,cy,zf,lquiet,ierr)
   ...
   if (ierr /= 0) then
      write (erstr,*) 'beam_dist004 error'
      call write_err(cls_name//sname//erstr)
   endif
...
subroutine deposit_fdist3d_004(this,q)
...
end subroutine deposit_fdist3d_004
