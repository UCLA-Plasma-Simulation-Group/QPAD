module field_solver_all_modes_b_class
...
public :: field_solver_all_modes_b
public :: HYPRE_BUF
...
type :: field_solver_all_modes_b ! class for HYPRE solver
...
end type field_solver_all_modes_b
...
subroutine init_field_solver( this, opts, max_mode, dr, kind, bnd, stype )
  ...
  class( field_solver_all_modes_b ), intent(inout) :: this
...
subroutine solve_equation( this, src, u)
...
subroutine set_struct_grid( this, opts )
  ...
  this%ilower(2) = 1
  this%iupper(1) = opts%get_noff(1) + opts%get_ndp(1) 
  this%iupper(2) = 4*this%mode+1 
        ...
        do aa = 0, 4*this%mode
          ...
          do bb = aa - 2*this%mode, aa + 2*this%mode
            if (aa == bb) then
              ...
              write(2,*) HYPRE_BUF(i),"HYPRE_BUF(i)"
              write(2,*) HYPRE_BUF(i- 2*this%mode - 1),"HYPRE_BUF(i - 2*this%mode - 1)"
...
end module field_solver_all_modes_b_class