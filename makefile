...
# Objects list
OBJS_MODULE = param.o ufield_class.o field_class.o field_solver_class.o field_psi_class.o
...
ufield_class.o : ufield_class.f03 param.o
	${FC} -c ${FORMAT_FREE} ufield_class.f03 -o ufield_class.o

field_class.o : field_class.f03 param.o ufield_class.o
	${FC} -c ${FORMAT_FREE} field_class.f03 -o field_class.o

field_solver_class.o : field_solver_class.f03 param.o
	${FC} -c ${FORMAT_FREE} field_solver_class.f03 -o field_solver_class.o

field_psi_class.o : field_psi_class.f03 param.o field_class.o field_solver_class.o
